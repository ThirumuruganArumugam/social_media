...
//         // Returns the ServiceResult with the content , message and the statusCode
...
//       // If there is an execption, Returns the ServiceResult statusCode as
...
//   /// The server is a transforming proxy that received a 200 OK from its origin, but is Returnsing a modified version of the origin's response.
//   NonAuthoritativeInformation,

//   /// The server successfully processed the request and is not Returnsing any content.
//   NoContent,

//   /// The server successfully processed the request, but is not Returnsing any content.
//   ResetContent,

//   /// The server is delivering only part of the resource due to a range header sent by the client.
//   PartialContent,

//   /// Multiple status codes are being Returnsed by the server.
//   MultiStatus,
...
//   /// The requested resource has been permanently moved to a new URI, and any future references to this resource should use one of the Returnsed URIs.
//   MovedPermanently,

//   /// The requested resource has been moved to a new URI, and any future references to this resource should use one of the Returnsed URIs.
//   Moved,
...
//   /// The requested resource has been temporarily moved to a new URI, and any future references to this resource should use one of the Returnsed URIs.
//   TemporaryRedirect,
